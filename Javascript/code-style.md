...
<!-- saved from url=(0073)https://raw.github.com/hiwanz/javascript-style-reference/master/README.md -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css"></style></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;"># Javascript代码及注释规范 2013/7/1 #
...
- [http://www.w3.org/TR/DOM-Level-2-HTML/html.html](http://www.w3.org/TR/DOM-Level-2-HTML/html.html)</pre><iframe id="rdbIndicator" width="100%" height="270" border="0" src="./code-style_files/indicator.htm" style="display: none; border: 0; position: fixed; left: 0; top: 0; z-index: 2147483647"></iframe></body></html>